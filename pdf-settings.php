...
class GFPDF_Settings
{
 ...
 <h2>Deployment</h2>
        ...
        <h2><?php echo PDF_EXTENDED_VERSION.' Patch'; ?></h2>
        <ol>
			<li><strong>Bug</strong> - Signatures stopped displaying after 2.1.0 update. Fixed issue. </li>        
        	<li><strong>Bug</strong> - First time install code now won't execute if already have configuration variables in database</li>
        </ol>
 	<h2><?php _e('What\'s new in v2.1.0?' , "gravityformspdfextended") ?></h2>
    
          <p>A number of features and bug fixes have been added to this release, as well as preparation (or housekeeping as we're calling it) for future releases.</p>
            <ol>
