...
<form method="post">
    ...
    <ol><li><strong>Bug: </strong> Fix mb_string bug in the new DOMPDF package.</li></ol>
    <h2><?php _e('v2.2.2 Changelog' , "gravityformspdfextended") ?></h2>
    <p>The DOMPDF library was updated for v<?php echo PDF_EXTENDED_VERSION; ?> to the latest stable release to help fix problems rendering tables, as well as some minor font changes.</p>
    <ol>
    	<li><strong>DOMPDF:</strong> We updated to the latest version of DOMPDF - DOMPDF 0.6.0 beta 3.</li>
    	<li><strong>DOMPDF: </strong>We've enabled font subsetting by default which should help limit the increased PDF size when using the non-default font.. </li>
    </ol>

	<h2><?php _e('v2.2.1 Changelog' , "gravityformspdfextended") ?></h2>
    <p>A small bug fix was released for v2.2.1.</p>
    <ol>
    	<li><strong>Bug: </strong>Fixed HTML error which caused list items to distort on rendered PDF</li>
    </ol>
    
    <h2><?php _e('v2.2.0 Changelog' , "gravityformspdfextended") ?></h2>
