...
{
	define('PDF_SAVE_LOCATION', get_stylesheet_directory()."/PDF_EXTENDED_TEMPLATES/output/");
}

if(!defined('PDF_TEMPLATE_LOCATION'))
{
	define('PDF_TEMPLATE_LOCATION', get_stylesheet_directory()."/PDF_EXTENDED_TEMPLATES/");
}
 ...
 */
 if (!function_exists('PDF_Generator')) {
	function PDF_Generator($form_id, $lead_id, $output = 'view', $return = false, $template = 'pdf-print-entry.php', $pdfname = '', $fpdf = false)
	{
