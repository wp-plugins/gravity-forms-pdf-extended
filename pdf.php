 ...
 */
 if(!defined('PDF_EXTENDED_VERSION')) { define('PDF_EXTENDED_VERSION', '3.0.2'); }
...
class GFPDF_Core extends PDFGenerator
{
	...
	public static function pdf_init() 
	{
		  ...
		  */
		  ...
		  {
			 add_action('after_plugin_row_' . GF_PDF_EXTENDED_PLUGIN_BASENAME, array(self, 'add_compatibility_error')); 
			 return;  
		  }
		  else
		  {
			 add_action('after_plugin_row_' . GF_PDF_EXTENDED_PLUGIN_BASENAME, array(self, 'add_documentation_byline'));
		  }	
