                ...
                foreach($form["fields"] as $field){
                    switch(RGFormsModel::get_input_type($field)){
                        ...
                        default:
                            ...
                            $value = RGFormsModel::get_lead_field_value($lead, $field);
                            $display_value = GFEntryDetail::pdf_get_lead_field_display($field, $value, $lead["currency"]);
                            ...
                            if($display_empty_fields || !empty($display_value) || $display_value === "0"){
                                ...
                                $content = '
                                <tr>
                                    <td colspan="2" class="entry-view-field-value' . $last_row . $even . '"><strong>' .  esc_html(GFCommon::get_label($field)) . '</strong> <span>' . $display_value . '</span></td>
                                </tr>';
                ...
                foreach($form["fields"] as $field){
                    switch(RGFormsModel::get_input_type($field)){
                        ...
                        default:
                            ...
                            $form_array[$field['id'].'.'.$field['label']] = GFEntryDetail::get_lead_field_display($field, $value, $lead["currency"]);
