                    ...
                    switch(RGFormsModel::get_input_type($field)){
                       case "section" :
						...
						case "signature":
							...
							{								
								 $content = '<div class="entry-view-field-value' . $last_row . $even . '"><strong>' .  esc_html(GFCommon::get_label($field)) . '</strong> <div>' . $display_value . '</div></div>	';							
                        ...
                        default:
                            ...
                            if($display_empty_fields || !empty($display_value) || $display_value === "0"){
                                ...
                                $content = '<div class="entry-view-field-value' . $last_row . $even . '"><strong>' .  esc_html(GFCommon::get_label($field)) . '</strong> <span>' . $display_value . '</span></div>';
