...
(is_defined('PDF_REPACK_FONT') && PDF_REPACK_FONT === true) ? $this->repackageTTF = true : $this->repackageTTF = false; 
...
// TABLES
(is_defined('PDF_ENABLE_SIMPLE_TABLES') && PDF_ENABLE_SIMPLE_TABLES === true) ? $this->simpleTables = true : $this->simpleTables = false; // Forces all cells to have same border, background etc. Improves performance
