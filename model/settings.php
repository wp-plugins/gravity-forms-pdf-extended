	...
	private function fresh_install()
	{
	 ...
	 private function is_initialised()
	 {
		  ...
		  */
		  ...
		  if( (get_option('gf_pdf_extended_deploy') == 'yes') && (get_option('gf_pdf_extended_installed') == 'installed') && (is_dir(PDF_TEMPLATE_LOCATION) ) && get_option('gf_pdf_extended_version') == PDF_EXTENDED_VERSION )
		  {
